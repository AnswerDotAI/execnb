...
<td>bool</td>
<td>False</td>
<td>Show stdout/stderr during execution</td>
</tr>
</tbody>
</table>
...
<a
href="https://github.com/AnswerDotAI/execnb/blob/main/execnb/shell.py#L157"
target="_blank" style="float:right; font-size:smaller">source</a>
...
>  CaptureShell.cell (cell, stdout=True, stderr=True, verbose=False)
...
>                            inject_idx:int=0, verbose:bool=False)
...
<a
href="https://github.com/AnswerDotAI/execnb/blob/main/execnb/shell.py#L291"
target="_blank" style="float:right; font-size:smaller">source</a>

### exec_nb

>  exec_nb (src:str, dest:str='', exc_stop:bool=False, inject_code:str=None,
>               inject_path:str=None, inject_idx:int=0, verbose:bool=False)
...
<a
href="https://github.com/AnswerDotAI/execnb/blob/main/execnb/shell.py#L305"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/execnb/blob/main/execnb/shell.py#L326"
target="_blank" style="float:right; font-size:smaller">source</a>
