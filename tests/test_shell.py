"""Nested execution: a cell driving `fastcore.nbio.run_cell` against a shell, run on the
shell's own loop. Pins that inner-run assignments persist in the right namespace and errors
stay structural."""
