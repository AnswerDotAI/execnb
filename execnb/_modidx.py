...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'execnb.shell': { 'execnb.shell.CaptureShell': ('shell.html#captureshell', 'execnb/shell.py'),
                              ...
                              'execnb.shell.CaptureShell._captured': ('shell.html#captureshell._captured', 'execnb/shell.py'),
                              'execnb.shell.CaptureShell._reap': ('shell.html#captureshell._reap', 'execnb/shell.py'),
                              'execnb.shell.CaptureShell._run': ('shell.html#captureshell._run', 'execnb/shell.py'),
                              'execnb.shell.CaptureShell._run_async': ('shell.html#captureshell._run_async', 'execnb/shell.py'),
                              'execnb.shell.CaptureShell._run_res': ('shell.html#captureshell._run_res', 'execnb/shell.py'),
                              'execnb.shell.CaptureShell.cell': ('shell.html#captureshell.cell', 'execnb/shell.py'),
                              'execnb.shell.CaptureShell.close': ('shell.html#captureshell.close', 'execnb/shell.py'),
                              ...
                              'execnb.shell.CaptureShell.load_profile': ('shell.html#captureshell.load_profile', 'execnb/shell.py'),
                              ...
                              'execnb.shell.CaptureShell.run_text': ('shell.html#captureshell.run_text', 'execnb/shell.py'),
                              'execnb.shell.CaptureShell.set_path': ('shell.html#captureshell.set_path', 'execnb/shell.py'),
                              'execnb.shell.CaptureShell.showsyntaxerror': ('shell.html#captureshell.showsyntaxerror', 'execnb/shell.py'),
                              'execnb.shell.CaptureShell.showtraceback': ('shell.html#captureshell.showtraceback', 'execnb/shell.py'),
                              ...
                              'execnb.shell._no_stdin': ('shell.html#_no_stdin', 'execnb/shell.py'),
                              ...
                              'execnb.shell._profile_cfg': ('shell.html#_profile_cfg', 'execnb/shell.py'),
                              'execnb.shell._strip': ('shell.html#_strip', 'execnb/shell.py'),
                              'execnb.shell._task_stacks': ('shell.html#_task_stacks', 'execnb/shell.py'),
                              ...
                              'execnb.shell.leading_comment_lines': ('shell.html#leading_comment_lines', 'execnb/shell.py'),
